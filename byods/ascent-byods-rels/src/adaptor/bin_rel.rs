...
use ascent::internal::{RelFullIndexRead, RelFullIndexWrite, RelIndexMerge, RelIndexWrite};
...
impl<'a, TBinRel: ByodsBinRel> RelIndexRead<'a> for ByodsBinRelInd0<'a, TBinRel> {
    ...
    type IteratorType =
        std::iter::Map<TBinRel::Ind0ValsIter<'a>, fn(&TBinRel::T1) -> (&TBinRel::T1,)>;
...
impl<'a, TBinRel: ByodsBinRel> RelIndexReadAll<'a> for ByodsBinRelInd0<'a, TBinRel> {
    ...
    type ValueIteratorType =
        std::iter::Map<TBinRel::Ind0AllIterValsIter<'a>, fn(&TBinRel::T1) -> (&TBinRel::T1,)>;
    type AllIteratorType = Map<
        ...
        for<'aa> fn(
            ...
            (&'aa TBinRel::T0,),
            Map<TBinRel::Ind0AllIterValsIter<'a>, fn(&TBinRel::T1) -> (&TBinRel::T1,)>,
        ),
    >;
...
impl<'a, TBinRel: ByodsBinRel> RelIndexRead<'a> for ByodsBinRelInd1<'a, TBinRel> {
    ...
    type IteratorType =
        std::iter::Map<TBinRel::Ind1ValsIter<'a>, fn(&TBinRel::T0) -> (&TBinRel::T0,)>;
...
impl<'a, TBinRel: ByodsBinRel> RelIndexReadAll<'a> for ByodsBinRelInd1<'a, TBinRel> {
    ...
    type ValueIteratorType =
        std::iter::Map<TBinRel::Ind1AllIterValsIter<'a>, fn(&TBinRel::T0) -> (&TBinRel::T0,)>;
    type AllIteratorType = Map<
        ...
        for<'aa> fn(
            ...
            (&'aa TBinRel::T1,),
            Map<TBinRel::Ind1AllIterValsIter<'a>, fn(&TBinRel::T0) -> (&TBinRel::T0,)>,
        ),
    >;
...
impl<'a, TBinRel: ByodsBinRel> RelIndexReadAll<'a> for ByodsBinRelInd0_1<'a, TBinRel> {
    ...
    type AllIteratorType = Map<
        TBinRel::AllIter<'a>,
        for<'aa> fn(
            (&'aa TBinRel::T0, &'aa TBinRel::T1),
        ) -> ((&'aa TBinRel::T0, &'aa TBinRel::T1), Once<()>),
    >;
