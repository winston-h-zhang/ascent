...
pub(crate) mod test {
    ...
    impl<T0, T1> ByodsBinRel for DummyRel<T0, T1> {
        ...
        fn contains(&self, _x0: &Self::T0, _x1: &Self::T1) -> bool {
            todo!()
        }
        ...
        fn ind0_index_get<'a>(&'a self, _key: &Self::T0) -> Option<Self::Ind0ValsIter<'a>> {
            todo!()
        }
        ...
        fn ind1_index_get<'a>(&'a self, _key: &Self::T1) -> Option<Self::Ind1ValsIter<'a>> {
            todo!()
        }
        fn insert(&mut self, _x0: Self::T0, _x1: Self::T1) -> bool {
            todo!()
        }
    }
