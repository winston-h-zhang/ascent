...
fn main() {
    ...
    prog.succ = vec![
        (
            ProgPoint(Instr("w1"), Context("c1")),
            ProgPoint(Instr("w2"), Context("c1")),
        ),
        (
            ProgPoint(Instr("w2"), Context("c1")),
            ProgPoint(Instr("r1"), Context("c1")),
        ),
        (
            ProgPoint(Instr("r1"), Context("c1")),
            ProgPoint(Instr("r2"), Context("c1")),
        ),
        (
            ProgPoint(Instr("w1"), Context("c2")),
            ProgPoint(Instr("w2"), Context("c2")),
        ),
        (
            ProgPoint(Instr("w2"), Context("c2")),
            ProgPoint(Instr("r1"), Context("c2")),
        ),
        (
            ProgPoint(Instr("r1"), Context("c2")),
            ProgPoint(Instr("r2"), Context("c2")),
        ),
    ];
